...
def not_worthy_response(description: Union[str, Dict[str, Any]], category: str) -> Dict[str, Any]:
    try:
        ...
        {{
        "summary": "<summary of the video in simple terms>",
        "reason": "<why it doesn't require fact-checking to sent to the end user write like your are talking user that , this this is the reason and thats why we are not able to verify it>",
        "category": "{category}"
        }}
